...
import io.github.astrapi69.mystic.crypt.panels.privatekey.CreatePrivateKeyPanel;
import io.github.astrapi69.swing.base.PanelDialog;

public class NewPrivateKeyFileDialog extends PanelDialog<MasterPwFileModelBean>
{
	...
	{
		return new CreatePrivateKeyPanel();
	}
}
